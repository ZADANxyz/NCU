...
const Store = () => {
  ...
  const handleAddToCart = (book: any) => {
    ...
    const newTotal = cartTotal + 15; // Assuming price is 15 for all books
    ...
    toast({
      ...
      description: (
        <div className="flex items-center gap-4">
          <img src={book.image} alt={book.title} className="w-16 h-16 object-contain rounded" />
          <div>
      ...
      action: (
        <ToastAction altText="View Cart" onClick={openCart}>
          View Cart
        </ToastAction>
      ),
    });
