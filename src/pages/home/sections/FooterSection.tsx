        ...
        <div className="absolute top-3 left-3 sm:left-6 md:left-[52px] right-3 sm:right-6 md:right-[52px] flex items-center justify-between z-30">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="w-8 h-8 bg-ncu-blue dark:bg-ncu-gold rounded-full flex items-center justify-center text-white hover:bg-ncu-blue-dark dark:hover:bg-ncu-gold-dark transition-all transform hover:scale-110"
            >
              <Facebook size={16} />
            </a>
            <a
