        ...
        <div className="absolute top-3 left-3 sm:left-6 md:left-[52px] right-3 sm:right-6 md:right-[52px] flex items-center justify-between z-30">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="w-8 h-8 bg-[#046BD2] dark:bg-[#B19528] rounded-full flex items-center justify-center text-white hover:bg-blue-700 dark:hover:bg-[#9a7d22] transition-all transform hover:scale-110"
            >
              <Facebook size={16} />
            </a>
            <a
