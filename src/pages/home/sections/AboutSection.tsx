    ...
    <section className="w-full bg-white dark:bg-[#242836] pt-12 md:pt-16 pb-12 md:pb-16 px-4 sm:px-6 md:px-[52px]">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-start">
        <div className="w-full lg:w-1/2 flex flex-col">
          ...
          <div className="w-full overflow-hidden rounded-lg h-64 sm:h-80 md:h-96">
            <AboutUsCarousel />
          </div>
        </div>

        <div className="w-full lg:w-1/2 flex flex-col justify-start lg:pr-4">
          <div className="text-base md:text-2xl font-roboto font-normal text-[#333] dark:text-gray-200 leading-relaxed mb-8 mt-0 lg:mt-20">
            <p>
