...
const StudentHandbook = () => {
  const handleDownload = () => {
    ...
    console.log("Download Student Handbook PDF");
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <main className="flex-1 pt-16">
        {/* PDF Section */}
        <section className="w-full pt-4 pb-2 bg-background">
          <div className="w-full px-3 sm:px-6 md:px-[52px]">
            ...
            <div className="w-full flex justify-center">
              <iframe 
                src="https://drive.google.com/file/d/12K1Wl23OLDSGzQXHsm5eDshBniyxm7Uu/preview?usp=drive_web&embedded=true" 
                width="100%" 
                height="15000px" 
                allow="autoplay"
